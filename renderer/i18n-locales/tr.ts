...
(function () {
  ...
  window.App.i18n.registerLocale('tr', {
    ...
    confirmDeleteSshUserFolderConnections: 'Bu işlem, silinen kullanıcıları kullanan {count} bağlantıyı da koparır.\nYeniden atanması gerekecektir.',
    ...
    sshImportWinScpBtnTitle: 'WinSCP kayıtlı sitelerinden yenilerini içe aktar',
    sshUpdateWinScpBtnTitle: 'WinSCP kayıtlı sitelerinden mevcut olanları güncelle',
    sshExportBtnTitle: 'Bağlantıları SSH yapılandırma dosyasına dışa aktar',
    sshNewConnBtnTitle: 'Yeni Bağlantı',
    sshNewFolderBtnTitle: 'Yeni Bağlantı Klasörü',
    sshNewUserFolderBtnTitle: 'Yeni Kullanıcı Klasörü',
    ...
    sshDialogTitleNewFolder: 'Yeni Bağlantı Klasörü',
    sshDialogTitleEditFolder: 'Bağlantı Klasörünü Düzenle',
    sshDialogTitleNewUserFolder: 'Yeni Kullanıcı Klasörü',
    sshDialogTitleEditUserFolder: 'Kullanıcı Klasörünü Düzenle',
    ...
    sshFolderOptional: 'Bağlantı Klasörü (isteğe bağlı)',
    sshFormUserFolderOptional: 'Kullanıcı Klasörü (isteğe bağlı)',
    sshFormUserUngrouped: '-- Gruplanmamış --',
    ...
    sshFormCiphers: 'Şifreleme algoritmaları',
    sshFormMacs: 'MAC',
    sshFormCaSignatureAlgorithms: 'CA imza algoritmaları',
    sshFormCompression: 'Sıkıştırma',
    sshFormAlgorithmGroup: 'Anlaşma algoritmaları',
    sshFormCompressionGroup: 'Sıkıştırma',
    ...
    sshFolderName: 'Bağlantı Klasörü Adı',
    sshFolderParent: 'Üst bağlantı klasörü',
    sshUserFolderName: 'Kullanıcı Klasörü Adı',
    sshUserFolderParent: 'Üst kullanıcı klasörü',
    sshUserFolderParentNone: '(yok — kök düzey)',
    ...
    sshImportNoExistingToUpdate: 'Güncellenecek mevcut bağlantı bulunamadı.',
    sshImportNoHosts: 'SSH yapılandırmasında sunucu bulunamadı.',
    sshImportWinScpTitle: 'WinSCP konumundan içe aktar',
    ...
    sshImportFolder: 'Klasör: {path}',

    // ── SSH Context Menu ─────────────────────────────────────────────────────
    sshCtxAddConn: 'Bağlantı Ekle',
    sshCtxAddFolder: 'Bağlantı Klasörü Ekle',
    sshCtxAddUserFolder: 'Kullanıcı Klasörü Ekle',
    sshCtxAddUser: 'Kullanıcı Ekle',
    sshCtxAddSubFolder: 'Bağlantı Alt Klasörü Ekle',
    sshCtxAddParentFolder: 'Üst Bağlantı Klasörü Ekle',
    ...
    sshDropdownImportBtn: 'SSH yapılandırmasından içe aktar',
    sshDropdownUpdateBtn: 'SSH yapılandırmasından güncelle',
    sshDropdownImportWinScpBtn: 'WinSCP konumundan içe aktar',
    sshDropdownUpdateWinScpBtn: 'WinSCP konumundan güncelle',
    sshDropdownExportBtn: 'SSH yapılandırmasına dışa aktar',
    sshDropdownConnBtn: 'Bağlantı',
    sshDropdownFolderBtn: 'Bağlantı Klasörü',
    sshDropdownUserFolderBtn: 'Kullanıcı Klasörü',
    ...
    sshDeleteTypeConnectionFolder: 'bağlantı klasörü',
    sshDeleteTypeUserFolder: 'kullanıcı klasörü',
