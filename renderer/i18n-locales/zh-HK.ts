...
(function () {
  ...
  window.App.i18n.registerLocale('zh-HK', {
    ...
    updDownloading: '正在下載…',
    updReadyBody: '版本 {version} 已準備好安裝',
    updInstallNow: '重新啟動並安裝',
    updSkipVersion: '略過此版本',
    updRemindLater: '30 日後提醒我',
    updSkippedVersion: '已略過的版本：{version}',
    updUndoSkip: '取消略過',
    ...
    updPortableManual: 'Portable 版不支援自動更新，已開啟 GitHub 下載頁。',
