...
(function () {
  ...
  window.App.i18n.registerLocale('pt-BR', {
    ...
    toastAllGroupsClosed: 'Todos os grupos foram fechados. Um novo grupo foi criado.',
    ...
    groupCtxCloseSelected: 'Fechar selecionados',
    groupCtxCloseOthers: 'Fechar outros',
    ...
    confirmCloseSelectedGroups: 'Fechar grupos selecionados ({count})?\nTodas as suas terminais serão encerradas.',
    confirmCloseOtherGroups: 'Fechar outros grupos ({count})?\nTodas as suas terminais serão encerradas.',
    ...
    sshImportWinScpBtnTitle: 'Importar novos dos sites salvos do WinSCP',
    sshUpdateWinScpBtnTitle: 'Atualizar existentes dos sites salvos do WinSCP',
    ...
    sshFormCiphers: 'Cifras',
    sshFormMacs: 'MACs',
    sshFormCaSignatureAlgorithms: 'Algoritmos de assinatura de CA',
    sshFormCompression: 'Compressão',
    sshFormAlgorithmGroup: 'Algoritmos de negociação',
    sshFormCompressionGroup: 'Compressão',
    ...
    sshImportNoExistingToUpdate: 'Nenhuma conexão existente encontrada para atualizar.',
    sshImportNoHosts: 'Nenhum host encontrado na configuração SSH.',
    sshImportWinScpTitle: 'Importar do WinSCP',
    sshImportWinScpUpdateTitle: 'Atualizar do WinSCP',
    sshImportWinScpSupported: 'Apenas sites SFTP e SCP são importados.',
    sshImportWinScpSkipped: 'Ignorados (protocolo não suportado): {list}',
    sshImportWinScpKeysUnsupported: 'Chaves .ppk do PuTTY não podem ser usadas para conectar (o OpenSSH não as lê), então nenhum arquivo de chave foi importado. Defina o caminho de chave aceito após a importação: {list}',
    sshImportWinScpNoSites: 'Nenhum site do WinSCP encontrado.',
    sshImportWinScpNotDetected: 'O WinSCP não foi detectado nesta máquina.',
    sshImportWinScpChooseIni: 'Escolher arquivo .ini do WinSCP…',
    sshImportFolder: 'Pasta: {path}',
    ...
    optionsTitleSsh: 'SSH',
    optionsFolderAutoEcho: 'Abrir pastas de conexões no modo Eco',
    ...
    sshDropdownImportBtn: 'Importar da configuração SSH',
    sshDropdownUpdateBtn: 'Atualizar da configuração SSH',
    sshDropdownImportWinScpBtn: 'Importar do WinSCP',
    sshDropdownUpdateWinScpBtn: 'Atualizar do WinSCP',
    sshDropdownExportBtn: 'Exportar para configuração SSH',
