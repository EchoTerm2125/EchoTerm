...
(function () {
  ...
  window.App.i18n.registerLocale('ja', {
    ...
    confirmDeleteSshUserFolderConnections: '削除されたユーザーを使用している {count} 件の接続も切断されます。\n再割り当てが必要になります。',
    ...
    sshImportWinScpBtnTitle: 'WinSCP の保存済みサイトから新規インポート',
    sshUpdateWinScpBtnTitle: 'WinSCP の保存済みサイトから既存を更新',
    sshExportBtnTitle: '接続を SSH 設定ファイルにエクスポート',
    sshNewConnBtnTitle: '新しい接続',
    sshNewFolderBtnTitle: '新しい接続フォルダ',
    sshNewUserFolderBtnTitle: '新しいユーザーフォルダ',
    ...
    sshDialogTitleNewFolder: '新しい接続フォルダ',
    sshDialogTitleEditFolder: '接続フォルダを編集',
    sshDialogTitleNewUserFolder: '新しいユーザーフォルダ',
    sshDialogTitleEditUserFolder: 'ユーザーフォルダを編集',
    ...
    sshFormPort: 'ポート',
    sshFormUser: 'ユーザー',
    sshFolderOptional: '接続フォルダ（省略可）',
    sshFormUserFolderOptional: 'ユーザーフォルダ（省略可）',
    sshFormUserUngrouped: '-- 未分類 --',
    ...
    sshFormCiphers: '暗号アルゴリズム',
    sshFormMacs: 'メッセージ認証コード',
    sshFormCaSignatureAlgorithms: 'CA 署名アルゴリズム',
    sshFormCompression: '圧縮',
    sshFormAlgorithmGroup: 'ネゴシエーションアルゴリズム',
    sshFormCompressionGroup: '圧縮',
    ...
    sshFolderName: '接続フォルダ名',
    sshFolderParent: '親接続フォルダ',
    sshUserFolderName: 'ユーザーフォルダ名',
    sshUserFolderParent: '親ユーザーフォルダ',
    sshUserFolderParentNone: '（なし — ルートレベル）',
    ...
    sshImportNoExistingToUpdate: '更新できる既存の接続が見つかりません。',
    sshImportNoHosts: 'SSH 設定にホストが見つかりません。',
    sshImportWinScpTitle: 'WinSCP からインポート',
    ...
    sshImportFolder: 'フォルダ: {path}',

    // ── SSH Context Menu ─────────────────────────────────────────────────────
    sshCtxAddConn: '接続を追加',
    sshCtxAddFolder: '接続フォルダを追加',
    sshCtxAddUserFolder: 'ユーザーフォルダを追加',
    sshCtxAddUser: 'ユーザーを追加',
    sshCtxAddSubFolder: '接続サブフォルダを追加',
    sshCtxAddParentFolder: '親接続フォルダを追加',
    sshCtxConnect: '接続',
    sshCtxEdit: '編集',
    ...
    optionsTitleSsh: 'SSH',
    optionsFolderAutoEcho: '接続フォルダをエコーモードで開く',
    ...
    sshDropdownImportWinScpBtn: 'WinSCP からインポート',
    sshDropdownUpdateWinScpBtn: 'WinSCP から更新',
    sshDropdownExportBtn: 'SSH 設定へエクスポート',
    sshDropdownConnBtn: '接続',
    sshDropdownFolderBtn: '接続フォルダ',
    sshDropdownUserFolderBtn: 'ユーザーフォルダ',
    ...
    sshDeleteTypeConnectionFolder: '接続フォルダ',
    sshDeleteTypeUserFolder: 'ユーザーフォルダ',
