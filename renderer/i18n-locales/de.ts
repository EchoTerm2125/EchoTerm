...
(function () {
  ...
  window.App.i18n.registerLocale('de', {
    ...
    toastAllGroupsClosed: 'Alle Gruppen geschlossen. Eine neue Gruppe wurde erstellt.',
    ...
    groupCtxCloseSelected: 'Ausgewählte schließen',
    groupCtxCloseOthers: 'Andere schließen',
    ...
    confirmCloseSelectedGroups: 'Ausgewählte Gruppen schließen ({count})?\nAlle ihre Terminals werden geschlossen.',
    confirmCloseOtherGroups: 'Andere Gruppen schließen ({count})?\nAlle ihre Terminals werden geschlossen.',
    ...
    confirmDeleteSshUserFolderConnections: 'Dies trennt auch {count} Verbindungen, die die gelöschten Benutzer verwenden.\nSie müssen neu zugewiesen werden.',
    ...
    sshImportWinScpBtnTitle: 'Neue aus gespeicherten WinSCP-Sites importieren',
    sshUpdateWinScpBtnTitle: 'Vorhandene aus gespeicherten WinSCP-Sites aktualisieren',
    ...
    sshFormCiphers: 'Verschlüsselungsverfahren',
    sshFormMacs: 'MACs',
    sshFormCaSignatureAlgorithms: 'CA-Signaturalgorithmen',
    sshFormCompression: 'Komprimierung',
    sshFormAlgorithmGroup: 'Aushandlungsalgorithmen',
    sshFormCompressionGroup: 'Komprimierung',
    ...
    sshImportNoExistingToUpdate: 'Keine vorhandenen Verbindungen zum Aktualisieren gefunden.',
    sshImportNoHosts: 'Keine Hosts in der SSH-Konfiguration gefunden.',
    sshImportWinScpTitle: 'Aus WinSCP importieren',
    sshImportWinScpUpdateTitle: 'Aus WinSCP aktualisieren',
    sshImportWinScpSupported: 'Nur SFTP- und SCP-Sites werden importiert.',
    sshImportWinScpSkipped: 'Übersprungen (nicht unterstütztes Protokoll): {list}',
    sshImportWinScpKeysUnsupported: 'PuTTY-.ppk-Schlüssel können nicht für die Verbindung verwendet werden (OpenSSH kann sie nicht lesen), daher wurde keine Schlüsseldatei importiert. Akzeptierten Schlüsselpfad nach dem Import festlegen: {list}',
    sshImportWinScpNoSites: 'Keine WinSCP-Sites gefunden.',
    sshImportWinScpNotDetected: 'WinSCP wurde auf diesem Computer nicht gefunden.',
    sshImportWinScpChooseIni: 'WinSCP-.ini-Datei wählen…',
    sshImportFolder: 'Ordner: {path}',
    ...
    sshDropdownImportBtn: 'Aus SSH-Konfiguration importieren',
    sshDropdownUpdateBtn: 'Aus SSH-Konfiguration aktualisieren',
    sshDropdownImportWinScpBtn: 'Aus WinSCP importieren',
    sshDropdownUpdateWinScpBtn: 'Aus WinSCP aktualisieren',
    sshDropdownExportBtn: 'In SSH-Konfiguration exportieren',
