...
(function () {
  ...
  window.App.i18n.registerLocale('ko', {
    ...
    updChecking: '업데이트 확인 중…',
    updUpToDate: '최신 버전입니다',
    updAvailableBody: '버전 {version}을(를) 사용할 수 있습니다',
    updDownloading: '다운로드 중…',
    updReadyBody: '버전 {version} 설치 준비 완료',
    updInstallNow: '다시 시작하고 설치',
    updSkipVersion: '이 버전 건너뛰기',
    updRemindLater: '30일 후에 알림',
    updSkippedVersion: '건너뛴 버전: {version}',
    updUndoSkip: '건너뛰기 취소',
