...
(function () {
  ...
  window.App.i18n.registerLocale('ru', {
    ...
    confirmUseDefaultEncryption: 'Шифрование по умолчанию не имеет защиты паролем.\nЛюбой, у кого есть доступ к этому приложению, сможет просмотреть сохранённые подключения.\nРекомендуем использовать защиту паролем.',
