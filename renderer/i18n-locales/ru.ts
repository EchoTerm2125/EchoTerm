...
(function () {
  ...
  window.App.i18n.registerLocale('ru', {
    ...
    confirmDeleteMultiSshConnectionFolder: 'При этом также будут навсегда удалены {connections} подключение(я) и {subfolders} вложенная(ые) папка(и) внутри.',
    ...
    sshImportWinScpBtnTitle: 'Импорт новых из сохранённых сайтов WinSCP',
    sshUpdateWinScpBtnTitle: 'Обновление существующих из сохранённых сайтов WinSCP',
    ...
    sshFormCiphers: 'Шифры',
    sshFormMacs: 'MAC',
    sshFormCaSignatureAlgorithms: 'Алгоритмы подписи CA',
    sshFormCompression: 'Сжатие',
    sshFormAlgorithmGroup: 'Алгоритмы согласования',
    sshFormCompressionGroup: 'Сжатие',
    ...
    sshImportNoExistingToUpdate: 'Существующие подключения для обновления не найдены.',
    sshImportNoHosts: 'В конфигурации SSH не найдено хостов.',
    sshImportWinScpTitle: 'Импорт из WinSCP',
    sshImportWinScpUpdateTitle: 'Обновление из WinSCP',
    sshImportWinScpSupported: 'Импортируются только сайты SFTP и SCP.',
    sshImportWinScpSkipped: 'Пропущено (неподдерживаемый протокол): {list}',
    sshImportWinScpKeysUnsupported: 'Ключи PuTTY .ppk нельзя использовать для подключения (OpenSSH их не читает), поэтому файл ключа не импортирован. Укажите принятый путь к ключу после импорта: {list}',
    sshImportWinScpNoSites: 'Сайты WinSCP не найдены.',
    sshImportWinScpNotDetected: 'WinSCP не обнаружен на этом компьютере.',
    sshImportWinScpChooseIni: 'Выбрать файл .ini WinSCP…',
    sshImportFolder: 'Папка: {path}',
    ...
    sshDropdownImportBtn: 'Импорт из конфигурации SSH',
    sshDropdownUpdateBtn: 'Обновление из конфигурации SSH',
    sshDropdownImportWinScpBtn: 'Импорт из WinSCP',
    sshDropdownUpdateWinScpBtn: 'Обновление из WinSCP',
    sshDropdownExportBtn: 'Экспорт в конфигурацию SSH',
