...
(function () {
  ...
  window.App.i18n.registerLocale('es', {
    ...
    toastAllGroupsClosed: 'Se cerraron todos los grupos. Se creó un grupo nuevo.',
    ...
    groupCtxCloseSelected: 'Cerrar seleccionados',
    groupCtxCloseOthers: 'Cerrar otros',
    ...
    confirmCloseSelectedGroups: '¿Cerrar grupos seleccionados ({count})?\nSe cerrarán todas sus terminales.',
    confirmCloseOtherGroups: '¿Cerrar otros grupos ({count})?\nSe cerrarán todas sus terminales.',
    ...
    confirmDuplicateSshConnectionFolder: '¿Duplicar la carpeta de conexiones "{name}"?\nTambién se copiarán {connections} conexión(es) y {subfolders} subcarpeta(s) dentro de ella.',
    confirmDuplicateSshUserFolder: '¿Duplicar la carpeta de usuarios "{name}"?\nTambién se copiarán {users} usuario(s) y {subfolders} subcarpeta(s) dentro de ella.',
    confirmDuplicateMultiSshConnectionFolder: '¿Duplicar {folders} carpetas de conexiones?\nTambién se copiarán {connections} conexión(es) y {subfolders} subcarpeta(s) dentro de ellas.',
    confirmDuplicateMultiSshUserFolder: '¿Duplicar {folders} carpetas de usuarios?\nTambién se copiarán {users} usuario(s) y {subfolders} subcarpeta(s) dentro de ellas.',
    ...
    sshImportWinScpBtnTitle: 'Importar nuevos desde sitios guardados de WinSCP',
    sshUpdateWinScpBtnTitle: 'Actualizar existentes desde sitios guardados de WinSCP',
    ...
    sshFormCiphers: 'Cifrados',
    sshFormMacs: 'MAC',
    sshFormCaSignatureAlgorithms: 'Algoritmos de firma de CA',
    sshFormCompression: 'Compresión',
    sshFormAlgorithmGroup: 'Algoritmos de negociación',
    sshFormCompressionGroup: 'Compresión',
    ...
    sshImportNoExistingToUpdate: 'No se encontraron conexiones existentes para actualizar.',
    sshImportNoHosts: 'No se encontraron hosts en la configuración SSH.',
    sshImportWinScpTitle: 'Importar desde WinSCP',
    sshImportWinScpUpdateTitle: 'Actualizar desde WinSCP',
    sshImportWinScpSupported: 'Solo se importan sitios SFTP y SCP.',
    sshImportWinScpSkipped: 'Omitidos (protocolo no compatible): {list}',
    sshImportWinScpKeysUnsupported: 'Las claves .ppk de PuTTY no pueden usarse para conectarse (OpenSSH no puede leerlas), así que no se importó ningún archivo de clave. Define la ruta de clave aceptada tras la importación: {list}',
    sshImportWinScpNoSites: 'No se encontraron sitios de WinSCP.',
    sshImportWinScpNotDetected: 'No se detectó WinSCP en este equipo.',
    sshImportWinScpChooseIni: 'Elegir archivo .ini de WinSCP…',
    sshImportFolder: 'Carpeta: {path}',
    ...
    findNextTitle: 'Siguiente coincidencia (Intro)',
    ...
    searchPanelRun: 'Buscar',
    searchPanelHint: 'Busca en los terminales en pantalla. Haz clic en un resultado para ir a él.',
    searchPanelEmpty: 'Ninguna pestaña abierta',
    searchPanelNoResults: 'Sin coincidencias',
    searchPanelTruncated: 'Mostrando las primeras {count} coincidencias',
    searchPanelCloseTitle: 'Cerrar',
    ...
    sshDropdownImportBtn: 'Importar desde configuración SSH',
    sshDropdownUpdateBtn: 'Actualizar desde configuración SSH',
    sshDropdownImportWinScpBtn: 'Importar desde WinSCP',
    sshDropdownUpdateWinScpBtn: 'Actualizar desde WinSCP',
    sshDropdownExportBtn: 'Exportar a configuración SSH',
