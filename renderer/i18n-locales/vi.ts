...
(function () {
  ...
  window.App.i18n.registerLocale('vi', {
    ...
    confirmDeleteSshConnectionFolder: 'Xóa thư mục kết nối "{name}"?\n{connections} kết nối và {subfolders} thư mục con bên trong sẽ bị xóa vĩnh viễn.',
    confirmDeleteMultiSshConnectionFolder: 'Thao tác này cũng sẽ xóa vĩnh viễn {connections} kết nối và {subfolders} thư mục con bên trong.',
    confirmDeleteSshUserFolder: 'Xóa thư mục người dùng "{name}"?\n{users} người dùng và {subfolders} thư mục con bên trong sẽ bị xóa vĩnh viễn.',
    ...
    sshImportWinScpBtnTitle: 'Nhập mới từ các site đã lưu của WinSCP',
    sshUpdateWinScpBtnTitle: 'Cập nhật các site đã lưu của WinSCP',
    sshExportBtnTitle: 'Xuất kết nối tới tệp cấu hình SSH',
    sshNewConnBtnTitle: 'Kết nối mới',
    sshNewFolderBtnTitle: 'Thư mục kết nối mới',
    sshNewUserFolderBtnTitle: 'Thư mục người dùng mới',
    ...
    sshDialogTitleNewFolder: 'Thư mục kết nối mới',
    sshDialogTitleEditFolder: 'Sửa thư mục kết nối',
    sshDialogTitleNewUserFolder: 'Thư mục người dùng mới',
    sshDialogTitleEditUserFolder: 'Sửa thư mục người dùng',
    ...
    sshFolderOptional: 'Thư mục kết nối (tùy chọn)',
    sshFormUserFolderOptional: 'Thư mục người dùng (tùy chọn)',
    sshFormUserUngrouped: '-- Chưa phân nhóm --',
    ...
    sshFormCiphers: 'Thuật toán mã hóa',
    sshFormMacs: 'MAC',
    sshFormCaSignatureAlgorithms: 'Thuật toán chữ ký CA',
    sshFormCompression: 'Nén',
    sshFormAlgorithmGroup: 'Thuật toán thương lượng',
    sshFormCompressionGroup: 'Nén',
    ...
    sshFolderName: 'Tên thư mục kết nối',
    sshFolderParent: 'Thư mục kết nối cha',
    sshUserFolderName: 'Tên thư mục người dùng',
    sshUserFolderParent: 'Thư mục người dùng cha',
    sshUserFolderParentNone: '(không có — cấp gốc)',
    ...
    sshImportNoExistingToUpdate: 'Không tìm thấy kết nối hiện có để cập nhật.',
    sshImportNoHosts: 'Không tìm thấy máy chủ nào trong cấu hình SSH.',
    sshImportWinScpTitle: 'Nhập từ WinSCP',
    ...
    sshImportFolder: 'Thư mục: {path}',

    // ── SSH Context Menu ─────────────────────────────────────────────────────
    sshCtxAddConn: 'Thêm kết nối',
    sshCtxAddFolder: 'Thêm thư mục kết nối',
    sshCtxAddUserFolder: 'Thêm thư mục người dùng',
    sshCtxAddUser: 'Thêm người dùng',
    sshCtxAddSubFolder: 'Thêm thư mục con kết nối',
    sshCtxAddParentFolder: 'Thêm thư mục kết nối cha',
    ...
    updStatusChecking: 'Đang kiểm tra cập nhật…',
    updStatusUpToDate: 'Bạn đang dùng phiên bản mới nhất',
    updStatusAvailable: 'Có bản cập nhật: {version}',
    ...
    sshDropdownImportWinScpBtn: 'Nhập từ WinSCP',
    sshDropdownUpdateWinScpBtn: 'Cập nhật từ WinSCP',
    sshDropdownExportBtn: 'Xuất sang cấu hình SSH',
    sshDropdownConnBtn: 'Kết nối',
    sshDropdownFolderBtn: 'Thư mục kết nối',
    sshDropdownUserFolderBtn: 'Thư mục người dùng',
    ...
    sshDeleteTypeConnectionFolder: 'thư mục kết nối',
    sshDeleteTypeUserFolder: 'thư mục người dùng',
