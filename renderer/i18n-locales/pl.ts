...
(function () {
  ...
  window.App.i18n.registerLocale('pl', {
    ...
    sshImportWinScpBtnTitle: 'Importuj nowe z zapisanych witryn WinSCP',
    sshUpdateWinScpBtnTitle: 'Aktualizuj istniejące z zapisanych witryn WinSCP',
    ...
    sshFormCiphers: 'Szyfry',
    sshFormMacs: 'MAC',
    sshFormCaSignatureAlgorithms: 'Algorytmy podpisu CA',
    sshFormCompression: 'Kompresja',
    sshFormAlgorithmGroup: 'Algorytmy negocjacji',
    sshFormCompressionGroup: 'Kompresja',
    ...
    sshImportNoExistingToUpdate: 'Nie znaleziono istniejących połączeń do zaktualizowania.',
    sshImportNoHosts: 'Nie znaleziono hostów w konfiguracji SSH.',
    sshImportWinScpTitle: 'Importuj z WinSCP',
    sshImportWinScpUpdateTitle: 'Aktualizuj z WinSCP',
    sshImportWinScpSupported: 'Importowane są tylko witryny SFTP i SCP.',
    sshImportWinScpSkipped: 'Pominięto (nieobsługiwany protokół): {list}',
    sshImportWinScpKeysUnsupported: 'Klucz PuTTY .ppk nie może być użyty do połączenia (OpenSSH go nie odczyta), więc nie zaimportowano pliku klucza. Ustaw akceptowaną ścieżkę klucza po imporcie: {list}',
    sshImportWinScpNoSites: 'Nie znaleziono witryn WinSCP.',
    sshImportWinScpNotDetected: 'Nie wykryto WinSCP na tym komputerze.',
    sshImportWinScpChooseIni: 'Wybierz plik .ini programu WinSCP…',
    ...
    sshDropdownImportBtn: 'Importuj z konfiguracji SSH',
    sshDropdownUpdateBtn: 'Aktualizuj z konfiguracji SSH',
    sshDropdownImportWinScpBtn: 'Importuj z WinSCP',
    sshDropdownUpdateWinScpBtn: 'Aktualizuj z WinSCP',
    sshDropdownExportBtn: 'Eksportuj do konfiguracji SSH',
