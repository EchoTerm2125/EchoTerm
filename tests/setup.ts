...
window.api = {
  ...
  sshUserDuplicate: vi.fn((userId) => Promise.resolve({ success: true, user: { id: `${userId}-copy` } })),
  ...
  sshConnectionFolderDuplicate: vi.fn((folderId) => Promise.resolve({ success: true, folder: { id: `${folderId}-copy`, parentId: null } })),
  ...
  sshUserFolderDuplicate: vi.fn((folderId) => Promise.resolve({ success: true, folder: { id: `${folderId}-copy`, parentId: null } })),
